...
const logo_mobile_namespaceObject = __webpack_require__.p + "assets/images/logo-mobile.5207d812.svg";
;// CONCATENATED MODULE: ./src/assets/images/icons/logo-dark.svg
const logo_dark_namespaceObject = __webpack_require__.p + "assets/images/logo-dark.7631ab21.svg";
;// CONCATENATED MODULE: ./src/assets/images/icons/logo-light.svg
const logo_light_namespaceObject = __webpack_require__.p + "assets/images/logo-light.bce8c971.svg";
;// CONCATENATED MODULE: ./src/assets/images/icons/icon-add-task-mobile.svg
const icon_add_task_mobile_namespaceObject = __webpack_require__.p + "assets/images/icon-add-task-mobile.97924c69.svg";
;// CONCATENATED MODULE: ./src/assets/images/icons/icon-vertical-ellipsis.svg
const icon_vertical_ellipsis_namespaceObject = __webpack_require__.p + "assets/images/icon-vertical-ellipsis.d7a338d7.svg";
...
function toggleThemeMode(htmlElement) {
...
;// CONCATENATED MODULE: ./src/assets/images/icons/icon-board.svg
const icon_board_namespaceObject = __webpack_require__.p + "assets/images/icon-board.3aed4c87.svg";
;// CONCATENATED MODULE: ./src/assets/images/icons/icon-light-theme.svg
const icon_light_theme_namespaceObject = __webpack_require__.p + "assets/images/icon-light-theme.4c3c9066.svg";
...
const icon_show_sidebar_namespaceObject = __webpack_require__.p + "assets/images/icon-show-sidebar.b186c9a8.svg";
